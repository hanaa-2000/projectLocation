package com.example.finalprojectlocation.locationreminders.data.local
...
import com.example.finalprojectlocation.locationreminder.local.RemnderDataBase
...
class RemindersLocalRepositoryTest {
    ...
    private lateinit var remindersLocalRepository: ReminderRepository

    private lateinit var database: RemnderDataBase
    ...
    fun setup() {
        ...
        database = Room.inMemoryDatabaseBuilder(
            ...
            RemnderDataBase::class.java
        ).allowMainThreadQueries().build()

        remindersLocalRepository = ReminderRepository(
